...
export default function MobileNav() {
  return (
    <nav className="flex md:hidden text-center text-sm font-semibold w-full h-10 bg-gray-900 text-white">
      ...
      <div className="w-11/12 h-auto flex justify-between items-center shadow-2xl">
        <a
          href="#"
          className="flex items-center text-center w-4/12 border-b-4 border-gray-400 h-full"
        >
          <p className="mx-auto">CHATS</p>
        </a>
        <a
          href="#"
          className="flex items-center text-center w-4/12 border-b-2 border-gray-400 h-full"
        >
